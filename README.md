...
-A token is used for checking the authetication of a user with a web-site. A user provides correct login and password and in exchange gets the authetication token.

What steps can you take in your web apps to keep your data secure?

-Protect any routes in our app from being rendered if the user is not authenticated with a token from the server.
-Use an authentication header with our API calls.
...
- A web server is a computer that runs software called a web server non-stopping 
 
Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

- POST is the “C” = create
- GET is the “R” = read
- PUT is the “U” = update
- DELETE is the “D” = delete
